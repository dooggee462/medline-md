  ...
  return (
    <>
      ...
      <main>
          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:gap-8 lg:py-24 lg:px-8">
            ...
            <div className="relative animate-fade-up [animation-delay:120ms]">
              <div className="relative mx-auto max-w-md rounded-3xl border border-slate-100 bg-white p-2 shadow-2xl shadow-brand-900/10">
                <div className="rounded-[1.3rem] bg-gradient-to-br from-brand-600 via-brand-600 to-brand-800 p-8 text-white">
              ...
              {/* Badge plutitor */}
              <div className="absolute -bottom-5 -left-3 flex items-center gap-2 rounded-2xl border border-slate-100 bg-white px-4 py-3 shadow-xl sm:-left-6">
        ...
        {/* ───────────── RECENZII ───────────── */}
        <section id="recenzii" className="scroll-mt-20 bg-brand-700 py-20 text-white lg:py-28">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
