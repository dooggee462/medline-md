...
export const SERVICES: ServiceDetail[] = [
  ...
  {
    slug: "codare-substante-narcotice",
    icon: "flask",
    relatedArticles: [
      "ghid-complet-codare-anti-alcool",
      "metode-codare-anti-alcool",
    ...
    content: {
      ro: {
        metaTitle:
          "Codare pentru Dependența de Substanțe în Chișinău | La Domiciliu — Medline.md",
        metaDescription:
          "Codare pentru dependența de substanțe narcotice în Chișinău, la domiciliu: evaluare medicală prealabilă, procedură confidențială, cu acordul informat al pacientului. Programare discretă 24/7.",
        keywords:
          "codare substante narcotice, codare droguri Chisinau, codare dependenta narcotice, tratament dependenta droguri Chisinau, codare la domiciliu narcotice, ajutor dependenta substante Chisinau, dezintoxicare narcotice domiciliu, kodirovanie ot narkotikov Chisinau",
        h1: "Codare pentru dependența de substanțe narcotice",
        short:
          "Procedură de codare pentru dependența de substanțe, după evaluare medicală și cu acordul pacientului.",
        lead: "Pe lângă codarea anti-alcool, echipa Medline efectuează codarea pentru dependența de substanțe narcotice, la domiciliu, în condiții de confidențialitate deplină. Procedura se face numai după o evaluare medicală prealabilă și numai cu acordul informat al pacientului — este o etapă dintr-un proces de recuperare, nu o soluție de sine stătătoare.",
        sections: [
          {
            heading: "Ce înseamnă codarea în cazul dependenței de substanțe",
            body: [
              "Codarea este o procedură prin care se creează o barieră puternică în calea consumului, susținută medicamentos și psihologic. Ea acționează asupra dorinței de a consuma, dar nu vindecă singură dependența și nu înlocuiește tratamentul complex al adicției.",
              "Rezultatul depinde în mod decisiv de decizia pacientului de a se opri. Codarea făcută sub presiunea familiei, fără voința persoanei, are șanse mici de reușită — de aceea nu efectuăm procedura fără acordul explicit al pacientului.",
              "Pentru o recuperare de durată, codarea trebuie continuată cu consiliere psihologică și, în multe cazuri, cu un program de reabilitare. Îți spunem deschis acest lucru de la început.",
            ],
          },
          {
            heading: "Evaluarea medicală dinaintea procedurii",
            body: [
              "Înainte de orice intervenție, asistentul medical evaluează starea pacientului: funcțiile vitale, starea de conștiență, afecțiunile cronice cunoscute, tratamentele în curs și momentul ultimului consum.",
              "Evaluarea nu e o formalitate. În funcție de substanța consumată, de vechimea dependenței și de starea generală, procedura poate fi amânată sau contraindicată. În aceste situații îți explicăm de ce și te îndrumăm către varianta potrivită.",
              "Consumul recent de substanțe, intoxicația acută sau sevrajul în desfășurare sunt situații în care codarea nu se poate efectua — organismul trebuie stabilizat mai întâi.",
            ],
          },
          {
            heading: "Confidențialitate",
            body: [
              "Deplasarea se face discret, fără însemne pe mașină și fără uniformă vizibilă. Nu lăsăm documente la vedere și nu contactăm pe nimeni în afara persoanei care ne-a chemat.",
              "Datele pacientului nu sunt comunicate nimănui — nici angajatorului, nici altor membri ai familiei, dacă pacientul nu dorește acest lucru.",
            ],
          },
          {
            heading: "Când este nevoie de urgență, nu de codare",
            body: [
              "Sună imediat la 112, nu la noi, dacă apar: respirație rară sau superficială, buze și unghii vinete, pierderea cunoștinței, convulsii, puls foarte lent sau foarte rapid, confuzie severă sau agitație extremă. Acestea pot fi semne de supradoză și necesită intervenție de urgență.",
              "Sevrajul la unele substanțe, în special la sedative și tranchilizante, poate pune viața în pericol dacă oprirea se face brusc și fără supraveghere medicală. Nu improviza acasă: sună-ne și evaluăm împreună ce se poate face în siguranță.",
              "Dacă pacientul are gânduri de a-și face rău, cere ajutor specializat de urgență. Codarea nu este răspunsul potrivit în acel moment.",
            ],
          },
        ],
        indications: [
          "Dependență de substanțe, cu decizia pacientului de a se opri",
          "Recăderi repetate după perioade de abstinență",
          "Pacienți care doresc discreție deplină, fără internare",
          "Situații în care deplasarea la clinică nu este posibilă",
          "Etapă de început într-un proces de recuperare mai amplu",
        ],
        benefits: [
          "Evaluare medicală înainte de orice intervenție",
          "Confidențialitate deplină, la domiciliu",
          "Asistenți medicali calificați, materiale sterile",
          "Programare non-stop, inclusiv noaptea și în weekend",
        ],
        faq: [
          {
            q: "Se poate face codarea fără acordul pacientului?",
            a: "Nu. Procedura se efectuează exclusiv cu acordul informat al persoanei. Fără voința ei, codarea nu este nici legală, nici eficientă — șansele de reușită sunt foarte mici.",
          },
          {
            q: "În cât timp ajungeți la domiciliu?",
            a: "În 25-45 de minute în Chișinău. Lucrăm non-stop, deci și noaptea sau în weekend echipa pornește în momentul apelului.",
          ...
          {
            q: "Codarea rezolvă complet dependența?",
            a: "Nu. Codarea creează o barieră puternică împotriva consumului, dar recuperarea de durată cere consiliere psihologică și, de multe ori, un program de reabilitare. Îți spunem deschis acest lucru înainte de procedură.",
          },
          {
            q: "Aflarea situației rămâne confidențială?",
            a: "Da. Ne deplasăm discret, fără însemne, și nu comunicăm nimănui datele pacientului — nici angajatorului, nici altor rude, dacă pacientul nu dorește.",
          },
          {
            q: "Ce se întâmplă dacă pacientul a consumat recent?",
            a: "În caz de consum recent, intoxicație sau sevraj în desfășurare, codarea nu se poate efectua — organismul trebuie stabilizat întâi. Asistentul stabilește la fața locului ce este posibil în siguranță.",
          },
        ],
      },
      ru: {
        metaTitle:
          "Кодирование от Наркотической Зависимости в Кишинёве | На Дому — Medline.md",
        metaDescription:
          "Кодирование от наркотической зависимости в Кишинёве, на дому: предварительная медицинская оценка, конфиденциальная процедура, только с информированного согласия пациента. Анонимная запись 24/7.",
        keywords:
          "кодирование от наркотиков, кодирование наркозависимости Кишинёв, лечение наркозависимости Кишинёв, кодирование на дому наркотики, помощь при наркозависимости Кишинёв, детоксикация наркотики на дому, анонимное кодирование Кишинёв",
        h1: "Кодирование от наркотической зависимости",
        short:
          "Процедура кодирования от зависимости, после медицинской оценки и с согласия пациента.",
        lead: "Помимо кодирования от алкоголя, команда Medline проводит кодирование от наркотической зависимости на дому, в условиях полной конфиденциальности. Процедура выполняется только после предварительной медицинской оценки и только с информированного согласия пациента — это этап процесса восстановления, а не самостоятельное решение проблемы.",
        sections: [
          {
            heading: "Что означает кодирование при наркозависимости",
            body: [
              "Кодирование — это процедура, создающая сильный барьер на пути к употреблению, с медикаментозной и психологической поддержкой. Оно воздействует на тягу к веществу, но само по себе не излечивает зависимость и не заменяет комплексное лечение.",
              "Результат решающим образом зависит от решения самого пациента прекратить употребление. Кодирование под давлением семьи, без воли человека, имеет мало шансов на успех — поэтому мы не проводим процедуру без явного согласия пациента.",
              "Для устойчивого восстановления после кодирования нужны психологическая помощь и, во многих случаях, реабилитационная программа. Мы говорим об этом прямо с самого начала.",
            ],
          },
          {
            heading: "Медицинская оценка перед процедурой",
            body: [
              "Перед любым вмешательством медработник оценивает состояние пациента: жизненные показатели, уровень сознания, известные хронические заболевания, текущее лечение и время последнего употребления.",
              "Эта оценка — не формальность. В зависимости от вещества, стажа зависимости и общего состояния процедура может быть отложена или противопоказана. В таком случае мы объясняем почему и направляем к подходящему решению.",
              "Недавнее употребление, острая интоксикация или развивающийся синдром отмены — состояния, при которых кодирование не проводится: сначала организм нужно стабилизировать.",
            ],
          },
          {
            heading: "Конфиденциальность",
            body: [
              "Выезд происходит незаметно: без опознавательных знаков на машине и без заметной формы. Мы не оставляем документов на виду и не связываемся ни с кем, кроме вызвавшего нас человека.",
              "Данные пациента не передаются никому — ни работодателю, ни другим родственникам, если пациент этого не желает.",
            ],
          },
          {
            heading: "Когда нужна неотложная помощь, а не кодирование",
            body: [
              "Немедленно звоните 112, а не нам, если появились: редкое или поверхностное дыхание, посинение губ и ногтей, потеря сознания, судороги, очень редкий или очень частый пульс, тяжёлая спутанность сознания или крайнее возбуждение. Это могут быть признаки передозировки.",
              "Синдром отмены некоторых веществ, особенно седативных и транквилизаторов, может быть опасен для жизни при резком прекращении без медицинского наблюдения. Не импровизируйте дома: позвоните, и мы вместе оценим, что можно сделать безопасно.",
              "Если у пациента есть мысли о причинении себе вреда, обратитесь за неотложной специализированной помощью. Кодирование в этот момент не является подходящим ответом.",
            ],
          },
        ],
        indications: [
          "Зависимость от веществ при решении пациента прекратить",
          "Повторные срывы после периодов воздержания",
          "Пациенты, которым важна полная анонимность, без госпитализации",
          "Ситуации, когда поездка в клинику невозможна",
          "Начальный этап более широкого процесса восстановления",
        ],
        benefits: [
          "Медицинская оценка перед любым вмешательством",
          "Полная конфиденциальность, на дому",
          "Квалифицированные медработники, стерильные материалы",
          "Запись круглосуточно, включая ночь и выходные",
        ],
        faq: [
          {
            q: "Можно ли провести кодирование без согласия пациента?",
            a: "Нет. Процедура проводится исключительно с информированного согласия человека. Без его воли кодирование не является ни законным, ни эффективным — шансы на успех крайне малы.",
          },
          {
            q: "Как быстро вы приезжаете на дом?",
            a: "За 25-45 минут в пределах Кишинёва. Работаем круглосуточно, поэтому ночью и в выходные бригада выезжает сразу после звонка.",
          ...
          {
            q: "Решает ли кодирование зависимость полностью?",
            a: "Нет. Кодирование создаёт сильный барьер против употребления, но устойчивое восстановление требует психологической помощи и часто реабилитационной программы. Мы говорим об этом прямо до процедуры.",
          },
          {
            q: "Останется ли это конфиденциальным?",
            a: "Да. Мы выезжаем незаметно, без опознавательных знаков, и не передаём данные пациента никому — ни работодателю, ни родственникам, если пациент этого не хочет.",
          },
          {
            q: "Что делать, если пациент недавно употреблял?",
            a: "При недавнем употреблении, интоксикации или развивающемся синдроме отмены кодирование не проводится — сначала нужно стабилизировать состояние. Медработник определяет на месте, что возможно безопасно.",
          },
        ],
      },
    },
...
export const RU_SLUG: Record<string, string> = {
  ...
  "codare-substante-narcotice": "kodirovanie-ot-narkotikov",
  // Articole blog
