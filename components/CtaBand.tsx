      ...
      <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
          <Link
            ...
            className="inline-flex items-center justify-center rounded-full bg-gradient-to-b from-gold-400 to-gold-600 px-7 py-3.5 text-base font-bold text-forest-950 shadow-lg transition-transform hover:scale-[1.02]"
          >
            {dict.ui.ctaButton}
          </Link>
          <a
